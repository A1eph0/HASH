...
int process_raw_string(char *raw_string, char *processed_string, char delim);       // processing the raw string to remove tabs, extra space, trailing space, newline, ampersand and empty commands
